# Baixa Videos 3000 by Reginaldo Horse
...
- Caso dê o erro "ffprobe and ffmpeg not found please install or provide the path using" no seu windows, abra o cmd e digite "winget install ffmpeg". Provavelmente meu instalador não conseguiu instalar o ffmpeg corretamente então você precisa fazer isso. Irei revisar isso e na próxima atualização isso deve ser consertado.
